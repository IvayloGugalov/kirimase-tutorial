...
export default function ReservationList({
  ...
  const { optimisticReservations, addOptimisticReservation } =
    useOptimisticReservations(reservations, restaurants)
  ...
  return (
    ...
    >
      ...
      <Button variant={'link'} asChild>
        <Link href={basePath + '/' + reservation.id}>Edit</Link>
      </Button>
    </li>
  )
}
    ...
    <div className='text-center'>
      ...
      <div className='mt-6'>
        <Button onClick={() => openModal()}>
          <PlusIcon className='h-4' /> New Reservations{' '}
        </Button>
      </div>
    </div>
  )
