...
export default function RestaurantList({
  ...
  const { optimisticRestaurants, addOptimisticRestaurant } = useOptimisticRestaurants(
    restaurants,
  ...
  return (
    ...
    >
      ...
      <Button variant={"link"} asChild>
        <Link href={ basePath + "/" + restaurant.id }>
          Edit
        </Link>
      </Button>
    </li>
    ...
    <div className="text-center">
      ...
      <div className="mt-6">
        <Button onClick={() => openModal()}>
          <PlusIcon className="h-4" /> New Restaurants </Button>
      </div>
    </div>
  );
};
