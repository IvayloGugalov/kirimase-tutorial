...
import { createReservation, deleteReservation, updateReservation } from "@/lib/api/reservations/mutations";

export const reservationsRouter = router({
  getReservations: publicProcedure.query(async () => {
    return getReservations();
  }),
  getReservationById: publicProcedure.input(reservationIdSchema).query(async ({ input }) => {
